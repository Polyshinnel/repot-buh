...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="payment-count__wrapper d-flex align-items-start">
                                    <p class="d-flex flex-column">
                                        <span class="text-bold text-lg">{{$returning_sum}} ₽</span>
                                        <span>Сумма возвратов</span>
                                    </p>

                                    <p class="d-flex flex-column ml-5">
                                        <span class="text-bold text-lg">{{$returning_count}}</span>
                    ...
                    <table id="returning-table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Дата платежа</th>
                                <th>Сумма платежа</th>
                            ...
                            @if($returnings)
                                @foreach($returnings as $returning)
                                    <tr>
                                        ...
                                        <td>
                                            @if($returning['link'] != 'Пусто')
                                                <a href="{{$returning['link']}}">Ссылка</a>
                                            @else
                                                <p>Заказ beauty</p>
                                            @endif
                                        </td>
    ...
    <script>
        ...
        //     })
        // });
        let table = $('#returning-table').DataTable({
            buttons: [
                'excel', 'print'
            ],
            order: [[0, 'desc']],
        ...
        table.buttons().container().appendTo('#returning-table_wrapper .col-md-6:first');
        $('#returning-table_wrapper .col-md-6:first').addClass('d-flex align-items-center')
        $('#returning-table_wrapper .col-md-6:nth-child(2)').addClass('d-flex align-items-center justify-content-end')
    </script>
